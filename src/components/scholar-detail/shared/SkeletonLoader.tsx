export function ProfileCardSkeleton() {
  return (
    <div className="bg-gradient-to-br from-violet-600 via-blue-600 to-blue-500 rounded-xl shadow-lg overflow-hidden">
      <div className="p-6">
        ...
        <div className="h-4 bg-white/20 rounded animate-pulse w-40 mb-4" />
        <div className="flex gap-1.5 mb-4">
          <div className="h-6 bg-white/20 rounded-full animate-pulse w-20" />
          <div className="h-6 bg-white/20 rounded-full animate-pulse w-24" />
        </div>
        <div className="flex gap-2 mb-4">
          <div className="flex-1 h-10 bg-white/20 rounded-lg animate-pulse" />
          <div className="flex-1 h-10 bg-white/20 rounded-lg animate-pulse" />
        </div>
